...
public class VideoViewCustom extends SurfaceView implements MediaPlayerControl {
	...
	// event.setClassName(VideoViewCustom.class.getName());
	// }
	//
	// @Override
	...
	// info.setClassName(VideoViewCustom.class.getName());
	// }
	...
	public void setMediaController(MediaControllerCustom controller) {
		...
		public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
			...
			if (getWindowToken() != null) {
				...
				if (framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
					...
					message = "invalid progressive playback error";
				} else {
					// messageId =
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		boolean isKeyCodeSupported = keyCode != KeyEvent.KEYCODE_BACK && keyCode != KeyEvent.KEYCODE_VOLUME_UP
				&& keyCode != KeyEvent.KEYCODE_VOLUME_DOWN && keyCode != KeyEventAPI11.KEYCODE_VOLUME_MUTE
